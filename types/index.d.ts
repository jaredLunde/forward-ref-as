...
declare type MergeProps<P1 = {}, P2 = {}> = Omit<P1, keyof P2> &
  (NeverKeys<P2> extends never ? P2 : Omit<P2, NeverKeys<P2>>)
declare type MergeWithDOMProps<
  E extends React.ElementType,
  P = {}
> = MergeProps<React.ComponentPropsWithRef<E>, P>
 ...
 */
declare type IntrinsicElement<E> = E extends ForwardRefExoticComponentWithAs<
  infer T,
  any
>
  ? T
...
declare type ExtendedProps<
  E,
  OwnProps
> = E extends ForwardRefExoticComponentWithAs<any, infer P>
